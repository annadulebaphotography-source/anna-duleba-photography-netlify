(function () {
    ...
    async function waitForPublishedPost(newSlug, statusElement) {
        const checkPath = `/pages/blog-${newSlug}.html`;
        ...
        for (let attempt = 1; attempt <= 24; attempt += 1) {
            ...
            try {
                ...
                // Keep waiting; Netlify can briefly return network/cache errors during deploy.
            }
        }
